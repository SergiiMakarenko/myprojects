...
<html>
  ...
  <div id="mainBlock">
      <form class="formWork" onsubmit="return checkForEmpty('viewRoles','error')" action="/roles.html" method="post">
          <a class="promptText"> Choice amount roles to view: </a>

          <c:if test="${portion==null}">
              <input class="viewRoles" id="range" type="range" min="5" max="20" step="5" name="portion"
      ...
      <h4>${userName}, where are roles by portion: </h4>
