...
<html>
  <head>
      ...
      <script src="js/english.js"></script>
            <script>
                function next(){
                    if(${fullList!=true}){
                        window.location = "/menus.html?portion=${portion}&startPosition=${startPosition+portion}"
                    }
                }
                function preview(){
                    if(${startPosition>0}){
  ...
  <div id="mainBlock">
      <form class="formWork" onsubmit="return checkForEmpty('input','error')" action="/menus.html" method="post">
          <a class="promptText"> Choice amount menus to view: </a>
