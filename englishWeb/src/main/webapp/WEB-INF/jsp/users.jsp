...
<html>
  <head>
      ...
      <script src="js/english.js"></script>
            <script>
                function next(){
                    if(${fullList!=true}){
                        window.location = "/users.html?portion=${portion}&startPosition=${startPosition+portion}"
                    }
                }
                function preview(){
                    if(${startPosition>0}){
  ...
  <div id="mainBlock">
      <form class="formWork" onsubmit="return checkForEmpty('viewUsers','error')" action="/users.html" method="post">
          <a class="promptText"> Choice amount users to view: </a>
      ...
      <h4>${userName}, where are users by portion: </h4>
